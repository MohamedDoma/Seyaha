    ...
    <li class="has-subnav">
        ...
        <diV class="table-wrapper">
            <div class="table-title">
                <div class="row">
                <a href="add_cafe.php" type="button" class="btn btn-info "><i class="fa fa-plus"></i> Add New</a>
                    <?php
                        $city_id = $_GET['id'];
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php
                    include "../config.php";
                    $city_id = $_GET['id'];
                    $query_pag_data = "SELECT * FROM cafe WHERE cafe_city_id = $city_id";
                    ...
                    {
                        $info_id = $row['cafe_id'];
                        $info_title = $row['cafe_name'];
                        $info_title_ar = $row['cafe_name_ar'];
                ?>
                ...
                <tr>
                    ...
                    <td><?php echo "<a href='edit_cafe.php?id=$row[cafe_id]'><i class='fa-solid fa-pen-to-square'></a>" ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
