...
if (isset($_POST['submit']))
{
    ...
    $select = mysqli_query($conn, "SELECT * FROM `employee` WHERE employee_name = '$user_name' AND employee_password = '$pass'") 
    or die ('query failed');
    ...
    {
            $insert = mysqli_query($conn, "INSERT INTO `employee` 
            (employee_name, employee_email, employee_password, users_type) VALUE
...
<head>
    ...
    <ul>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input hidden type="text" name="user_type" value="3">
