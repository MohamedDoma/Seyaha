    ...
    <ul>
        ...
        <diV class="table-wrapper">
            <div class="table-title">
                <div class="row">
                <a href="add_news.php" type="button" class="btn btn-info "><i class="fa fa-plus"></i> Add New</a>
                    <div><h2>News <b></b></h2></div>
                </div>
            </div>
            ...
            <tbody>
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($result_pag_data))
                    {
                        ...
                        $news_title_ar = $row['news_title_ar'];
                ...
                <tr>
                    ...
                    <td><?php echo $news_title_ar; ?></td>
                    <td><?php if ($news_status == 1)
                                {
                                    echo "Publish";
                                } 
                    ...
                    ?></td>
                    <td><?php echo "<a href='edit_news.php?id=$row[news_id]'><i class='fa-solid fa-pen-to-square'></a>" ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
