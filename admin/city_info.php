    ...
    <ul>
        ...
        <diV class="table-wrapper">
            <div class="table-title">
                <div class="row">
                <a href="add_info.php" type="button" class="btn btn-info "><i class="fa fa-plus"></i> Add New</a>
                    <?php
                        $city_id = $_GET['id'];
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php
                    include "../config.php";
                    $city_id = $_GET['id'];
                    $query_pag_data = "SELECT * FROM city_info WHERE info_city_id = $city_id";
                    ...
                    while($row = mysqli_fetch_assoc($result_pag_data))
                    {
                        ...
                        $info_title_ar = $row['info_title_ar'];
                ?>
                ...
                <tr>
                    ...
                    <td><?php echo "<a href='edit_info.php?id=$row[info_id]'><i class='fa-solid fa-pen-to-square'></a>" ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
