    ...
    <ul>
        ...
        <diV class="table-wrapper">
            <div class="table-title">
                <div class="row">
                <a href="add_hotel.php" type="button" class="btn btn-info "><i class="fa fa-plus"></i> Add New</a>
                    <?php
                        $city_id = $_GET['id'];
                    ...
                    {
                    ?>
                    <div><h2><?php echo $city_name; ?> <b></b></h2></div>
                    <?php
                    }
                    ?>
                </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php
                    include "../config.php";
                    $city_id = $_GET['id'];
                    $query_pag_data = "SELECT * FROM hotel WHERE hotel_city_id = $city_id";
                    ...
                    {
                        $info_id = $row['hotel_id'];
                        $info_title = $row['hotel_name'];
                        $info_title_ar = $row['hotel_name_ar'];
                ?>

                <tr>
                    <td><?php echo $i++ ?></td>
                    <td><?php echo $info_title; ?></td>
                    <td><?php echo $info_title_ar; ?></td>
                    <td><?php echo "<a href='edit_hotel.php?id=$row[hotel_id]'><i class='fa-solid fa-pen-to-square'></a>" ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
